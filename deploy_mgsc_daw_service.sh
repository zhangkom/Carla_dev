...
docker run -d \
  ...
  -e MUSIC_SERVICE_DUMMY_SLEEP_DIVISOR="${MUSIC_SERVICE_DUMMY_SLEEP_DIVISOR:-}" \
  -e MUSIC_SERVICE_DUMMY_SLEEP_DIVISOR_BY_PLUGIN="${MUSIC_SERVICE_DUMMY_SLEEP_DIVISOR_BY_PLUGIN:-vst_keyzone_classic=16}" \
  ...
  -e MUSIC_SERVICE_BUFFER_SIZE="${MUSIC_SERVICE_BUFFER_SIZE:-}" \
  -e MUSIC_SERVICE_BUFFER_SIZE_BY_TYPE="${MUSIC_SERVICE_BUFFER_SIZE_BY_TYPE:-vst=4096}" \
  -e MUSIC_SERVICE_BUFFER_SIZE_BY_PLUGIN="${MUSIC_SERVICE_BUFFER_SIZE_BY_PLUGIN:-vst_keyzone_classic=512}" \
  -e MUSIC_SERVICE_RENDER_WAV_STATS="${MUSIC_SERVICE_RENDER_WAV_STATS:-0}" \
  -e MUSIC_SERVICE_LOG_RENDER_EVENTS="${MUSIC_SERVICE_LOG_RENDER_EVENTS:-0}" \
  -e MUSIC_SERVICE_PARALLEL_ROUTES="${MUSIC_SERVICE_PARALLEL_ROUTES:-1}" \
  -e MUSIC_SERVICE_PARALLEL_ROUTE_WORKERS="${MUSIC_SERVICE_PARALLEL_ROUTE_WORKERS:-}" \
