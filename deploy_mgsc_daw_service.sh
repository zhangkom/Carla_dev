...
docker run -d \
  ...
  -e MUSIC_SERVICE_DUMMY_SLEEP_DIVISOR_BY_PLUGIN="${MUSIC_SERVICE_DUMMY_SLEEP_DIVISOR_BY_PLUGIN:-}" \
  -e MUSIC_SERVICE_RENDER_WARMUP_SECONDS="${MUSIC_SERVICE_RENDER_WARMUP_SECONDS:-}" \
  -e MUSIC_SERVICE_RENDER_WARMUP_SECONDS_BY_PLUGIN="${MUSIC_SERVICE_RENDER_WARMUP_SECONDS_BY_PLUGIN:-}" \
